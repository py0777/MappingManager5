...
//	}
	...
	public IDataSet modifyDef(IDataSet requestData) throws Exception{
		...
		try {
			...
			if( requestData.getRecordSet("deletedRows") != null){
				delDef( requestData);
			}else if( requestData.getRecordSet("updatedRows") != null){
				/*갱신*/
				upDef( requestData);
			}else if( requestData.getRecordSet("createdRows") != null){
				/*등록*/
				insertDef( requestData);	
			}
	 ...
	 * @throws Exception
	 */
	private IDataSet delDef(IDataSet requestData) throws Exception{
		logger.debug("###########  START delDef #########");
		logger.debug(getClass().getName());
	 ...
	 * @throws Exception
	 */
	private IDataSet upDef(IDataSet requestData) throws Exception{
		logger.debug("###########  START upDef #########");
		logger.debug(getClass().getName());
	...
	private IDataSet insertDef(IDataSet requestData) throws Exception{
		logger.debug("###########  START insertDef #########");
		logger.debug(getClass().getName());
