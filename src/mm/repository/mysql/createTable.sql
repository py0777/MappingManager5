...
ALTER DATABASE META_TABLE_MAP DEFAULT CHARACTER SET utf8;
ALTER table meta_table_map convert to CHARACTER set utf8;
...
ALTER table META_CODE_MAP convert to CHARACTER set utf8;
...
ALTER table META_TABLE_MAP_CRR convert to CHARACTER set utf8;
...
ALTER table META_TABLE_MAP_HST convert to CHARACTER set utf8;

GRANT SELECT, INSERT, UPDATE, DELETE ON META_TABLE_MAP_HST TO py0777;

ALTER DATABASE py0777 DEFAULT CHARACTER SET utf8 ;
