...
/*20190111 BlancoSqlToken을 PySqlToken로 변경 하기  */
public class PySqlParser
{
  ...
  PySqlToken nextToken()
  {
    ...
    if (isLetter(fChar)) {
      ...
      for (int i = 0; i < PySqlConstants.SQL_RESERVED_WORDS.length; i++) {
        if (s.compareToIgnoreCase(PySqlConstants.SQL_RESERVED_WORDS[i]) == 0)
        {
